...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'base_rbt.all': {},
            ...
            'base_rbt.base_model': { 'base_rbt.base_model.BarlowTrainer': ('base_model.html#barlowtrainer', 'base_rbt/base_model.py'),
                                     ...
                                     'base_rbt.base_model.VICReg.show': ('base_model.html#vicreg.show', 'base_rbt/base_model.py'),
                                     'base_rbt.base_model.VICReg.vicreg_loss': ( 'base_model.html#vicreg.vicreg_loss',
                                                                                 'base_rbt/base_model.py'),
                                     ...
                                     'base_rbt.base_model.get_vicreg_splitter': ( 'base_model.html#get_vicreg_splitter',
                                                                                  'base_rbt/base_model.py'),
                                     ...
                                     'base_rbt.base_model.my_splitter_bt_last_block_resnet50': ( 'base_model.html#my_splitter_bt_last_block_resnet50',
                                                                                                 'base_rbt/base_model.py'),
                                     'base_rbt.base_model.my_splitter_vicreg': ( 'base_model.html#my_splitter_vicreg',
                                                                                 'base_rbt/base_model.py'),
