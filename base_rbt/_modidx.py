  ...
  'syms': { 'base_rbt.all': {},
            ...
            'base_rbt.base_model': { 'base_rbt.base_model.BarlowTrainer': ('base_model.html#barlowtrainer', 'base_rbt/base_model.py'),
                                     ...
                                     'base_rbt.base_model.RandomGaussianBlur.encodes': ( 'base_model.html#randomgaussianblur.encodes',
                                                                                         'base_rbt/base_model.py'),
                                     'base_rbt.base_model.RandomHalfMask': ('base_model.html#randomhalfmask', 'base_rbt/base_model.py'),
                                     'base_rbt.base_model.RandomHalfMask.__init__': ( 'base_model.html#randomhalfmask.__init__',
                                                                                      'base_rbt/base_model.py'),
                                     'base_rbt.base_model.RandomHalfMask.encodes': ( 'base_model.html#randomhalfmask.encodes',
                                                                                     'base_rbt/base_model.py'),
